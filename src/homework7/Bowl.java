...
public class Bowl {
    ...
    public Bowl(int food, int capacity) {
        ...
        if (this.food > this.capacity) {
            ...
            System.out.println("Поскольку в миску попытались положить больше еды, чем она может вместить - лишняя еда вывалилась из миски. В следующий раз надо взять тару побольше.");
        }
    }
